package com.mkeducation.mkencryptor;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupWebView() {
        ...
        webView.addJavascriptInterface(new EncryptorBridge(), "AndroidBridge");
    ...
    private void loadApp() {
        webView.loadUrl("file:///android_asset/MK_Encryptor.html");
    }
    ...
    public class EncryptorBridge {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    cv.put(MediaStore.Downloads.RELATIVE_PATH,
                           Environment.DIRECTORY_DOWNLOADS + "/MKEncryptor");
                ...
                runOnUiThread(() ->
                    Toast.makeText(MainActivity.this,
                        "✅ " + fileName + " — Downloads/MKEncryptor-ல் சேமிக்கப்பட்டது!",
        ...
        public void shareFile(String base64Data, String fileName) {
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "MK Encryptor — " + fileName);
        ...
        public String getAppVersion() {
            return "MK Encryptor Android 1.0";
        }
